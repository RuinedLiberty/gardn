...
static void make_petal_tooltip(PetalID::T id) {
    ...
    Element *tooltip = new Ui::VContainer({
        ...
        PETAL_DATA[id].health == 0 ? nullptr : new Ui::StaticText(12, "Health: " + format_score(PETAL_DATA[id].health), { .fill = 0xffffff90, .h_justify = Style::Left }),
        PETAL_DATA[id].damage == 0 ? nullptr : new Ui::StaticText(12, "Damage: " + format_score(PETAL_DATA[id].damage), { .fill = 0xffffff90, .h_justify = Style::Left }),
